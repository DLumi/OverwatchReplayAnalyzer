...
class Player:
    ...
    def get_ult_status(self):
        ...
        prob_ssim = structural_similarity(
                            temp_ult_icon,
                            ult_icon_ref)
    ...
    def get_chara(self):
        ...
        for (name, avatar_ref_observed) in avatars_ref_observed.items():
            ...
            s_ssim_observed = structural_similarity(temp_avatar_observed, avatar_ref_observed, channel_axis=2)
    ...
    def _identify_ult_charge_digit(self, digit, digit_refs):
        ...
        for i in range(10):
            ...
            score_ssim = structural_similarity(temp_digit, digit_refs[i], win_size=3)
